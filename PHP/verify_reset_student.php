...
if (!isset($_SESSION['reset_pending']) || !isset($_SESSION['student_id']) || !isset($_SESSION['email'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['verification_code'])) {
        ...
        try {
            // First check if there's any code for this student
            $check_stmt = $conn_student->prepare("
                ...
                LIMIT 1
            ");
            $check_stmt->bind_param("ss", $student_id, $submitted_code);
            $check_stmt->execute();
            ...
            if ($result->num_rows === 0) {
                ...
                if (strtotime($code_data['expires_at']) < time()) {
                    ...
                    $update_stmt = $conn_student->prepare("
                        UPDATE student_verification_codes 
                        SET is_used = 1 
                        WHERE student_id = ? AND code = ?
                    ");
                    $update_stmt->bind_param("ss", $student_id, $submitted_code);
                    ...
                    if ($update_stmt->execute()) {
                        ...
                        header('Location: reset_password_student.php');
                        exit();
                    } else {
...
<body>
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="links">
                <a href="forgot_password_student.php">
