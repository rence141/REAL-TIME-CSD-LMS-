...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="view_attendance_student.php" class="nav-item"><i class="material-icons">check_circle</i> <span>Attendance</span></a>
            <a href="view_grades.php" class="nav-item"><i class="material-icons">grade</i> <span>Grading</span></a>
            ...
            <div class="activity-grid">
                <?php if ($activities->num_rows > 0): ?>
                    <?php while ($activity = $activities->fetch_assoc()): ?>
                        <div class="activity-card" onclick="window.location.href='activity_view_student.php?activity_id=<?php echo $activity['activity_id']; ?>'">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Wait for your Professor to post activities</p>
                        </button>
                    </div>
                <?php endif; ?>
            </div>
