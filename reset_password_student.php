...
if (!isset($_SESSION['reset_confirmed']) || !isset($_SESSION['student_id'])) {
    ...
    if (isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
        ...
        if (strlen($new_password) < 8) {
            ...
            try {
                ...
                $update_stmt = $conn_student->prepare("UPDATE students SET password = ? WHERE id = ?");
                ...
                error_log("Password reset failed for student_id: $student_id. Error: " . $e->getMessage());
            }
        }
    }
}
